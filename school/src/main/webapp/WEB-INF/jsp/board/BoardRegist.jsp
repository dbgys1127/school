				...
				<table class="chart2">
					...
					<tbody>
						<tr>
							<th scope="row">제목</th>
							<td>
								<input type="text" id="boardSj" title="제목입력" class="q3" value="<c:out value="${result.boardSj}" />">
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<c:out value="${USER_INFO.id}"></c:out>
							</td>
						</tr>
						<tr>
							<th scope="row">내용</th>
							<td>
								<textarea id="boardCn" name="boardCn" title="내용입력" rows="15">
									<c:out value="${result.boardCn}"></c:out>
								</textarea>
							</td>
						</tr>
					</tbody>
