...
@Controller
public class AdminReservationApplyController {
	...
	//예약자 정보 목록 가져오기 
	@RequestMapping("/admin/rsv/selectApplyList.do")
	public String selectApplyList(@ModelAttribute("searchVO") ReservationApplyVO searchVO, Model model) throws Exception{
	...
	//예약자 정보 상세
	@RequestMapping("/admin/rsv/rsvApplySelect.do")
	public String rsvApplySelect(@ModelAttribute("searchVO") ReservationApplyVO searchVO, Model model) throws Exception{
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		if(user == null || user.getId() == null) {
			model.addAttribute("message", "로그인 후 사용 가능합니다.");
			//return "forward:" + Globals.MAIN_PAGE;
	...
	//예약정보 승인
	@RequestMapping("/admin/rsv/rsvApplyConfirm.do")
	public String updateReservationConfirm(@ModelAttribute("searchVO") ReservationApplyVO searchVO, Model model, HttpServletRequest request) throws Exception{
	...
	//예약정보 삭제
	@RequestMapping("/admin/rsv/rsvApplyDelete.do")
	...
	//자바로 엑셀 다운로드하는 거
	@RequestMapping("/admin/rsv/excel.do")
	public ModelAndView excel(@ModelAttribute("searchVO") ReservationApplyVO searchVO, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception{
	...
	//엑셀업로드
	@PostMapping(value="/admin/rsv/excelUpload.json")
	public @ResponseBody JsonResponse excelUpload (@ModelAttribute ReservationApplyVO searchVO,  Model model, HttpServletRequest request, MultipartHttpServletRequest multiRequest, HttpServletResponse response) throws Exception{
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
