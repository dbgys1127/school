...
public class BoardController {
	...
	@RequestMapping("/board/selectList.do")
	public String selectList(@ModelAttribute("searchVO") BoardVO searchVO, HttpServletRequest request, Model model) throws Exception{
		//공지 게시글
	...
	//게시물의 상세페이지에 내용 가져오는 거
	@RequestMapping("/board/select.do")
	public String select(@ModelAttribute("searchVO") BoardVO searchVO, HttpServletRequest request, Model model) throws Exception {
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		model.addAttribute("USER_INFO", user);
	...
	public String boardRegist(@ModelAttribute("searchVO") BoardVO BoardVO, HttpServletRequest request, Model model) throws Exception {
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
	...
	public String insert(@ModelAttribute("searchVO") BoardVO searchVO, HttpServletRequest request, Model model) throws Exception {
		//이중 등록 방지 체크
	...
	public String update(@ModelAttribute("searchVO") BoardVO searchVO, HttpServletRequest request, Model model) throws Exception {
		//이중 서브밋 방지 체크
		if(request.getSession().getAttribute("sessionBoard") != null) {
			return "forward:/board/selectList.do";
		}
	...
	public String delete(@ModelAttribute("searchVO") BoardVO searchVO, HttpServletRequest request, Model model) throws Exception {
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		if(user == null) {
			model.addAttribute("message", "로그인 후 사용가능합니다");
			return "forward:/board/selectList.do";
